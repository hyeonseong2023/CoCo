...
const User = ({ data, anotherId }) => {
  ...
  const handleSubmit = () => {
    ...
    axios
      .put(`${process.env.REACT_APP_URL_8099}/userinfoupdate`, formData, {
        headers: {
  ...
  const deleteCust = async () => {
    ...
    try {
      await axios.delete('http://localhost:8099/deletecust', {
        data: requestData,
      });
    ...
    <div>
      ...
      <div className="Mypage-user-container">
        ...
        {!anotherId && (
          <img
            src={editBtn}
            className="Mypage-user-eidt-button "
            onClick={(e) => {
              setModalOpen(true);
            }}
          />
          ...
          <div className="Mypage-modal-user-container">
            ...
            <div className="Mypage-modal-user-close">
              ...
              <img
                ...
                className="Mypage-modal-user-close-button"
              ></img>
            </div>
            ...
            <div>
              ...
              <form method="put">
                ...
                <div>
                  <button
                    className="Mypage-modal_add_Button"
                    type="submit"
                  ...
                  <button
                    className="Mypage-modal_delete_Button"
                    type="submit"
      ...
      {deleteModalOpen && (
        <div className="Mypage-modal-user-back">
          <div className="Mypage-modal-user-container">
            ...
            <button
              className="Mypage-modal_delete_Cancle"
              type="submit"
              onClick={closeDeletePopup}
            >
              {' '}
