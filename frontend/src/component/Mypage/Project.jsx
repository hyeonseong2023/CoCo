...
const Project = ({ data }) => {
  ...
  // 해당 프로젝트 클릭시 
  const HandleProject =(id, CamLink) =>{   //게시글번호와 화상회의 링크를 전달받음 
  ...
  return (
    ...
    <div> 
      { projectData.length == 0 && (
          <div>  
          <div  className='null-project'> <span>같이 작업중인 팀원들이 없어요 </span> </div>
            <img src={teamSelect} className='teamSelect' onClick={HandleTeamSelect}></img>
          </div>
      )}
