              ...
              <div className="port-text">
                ...
                {menuOpenIndex === index &&
                  <ui className="menu-container">
                    <li  onClick={() => openNameModal(item.text, item.id)}>수정</li>
                    <li  onClick={() => openDeleteModal(item.text, item.id)}>삭제</li>
                  </ui>
                }
              </div>
            </div>
              ...
              <form>
                <table className='modal-port-table'>
                  ...
                  <tr>
                    ...
                    <td><input className='port-modal-content' type="text" value={pdfTitle} onChange={(e) => { setPdfTitle(e.target.value) }} /> </td>
                  </tr>
                  <tr>
                    <td className='port-modal-name'>첨부파일</td>
                    <td> <input className='port-modal-content' type="text" value={pdfName} /> </td>
                ...
                <div>
                  <button className="modal_add_Btn" type="submit" onClick={handleSubmit}>저장</button>
                </div>
              </form>
            </div>
          </div>
      ...
      {nameModalOpen && (
        <div className='port-modal-user-back'>
          <div className='port-modal-user-container'>
            ...
            <div className='modal-user-close'>
              <img className='port-modal-user-img' src={Logo}></img>
              <img src={X} onClick={closeNameModal} className="port-modal-user-close-button"></img>
            </div>
            ...
            <div>
              <form>
                <table className='modal-modify-port-table'>
                  ...
                  <tr>
                    <td className='port-modal-name'>포트폴리오명</td>
                    <td><input className='port-modal-content' type="text" value={portName} onChange={(e) => setPortName(e.target.value)} /></td>
                  </tr>
                </table>

                <div>
                  <button className="modal_add_Btn" type="submit" onClick={handleName}>저장</button>
                </div>
              </form>
            </div>
          </div>
      ...
      {deleteModalOpen && (
        <div className='port-modal-user-back'>
          <div className='port-modal-user-container'>
            ...
            <div className='modal-user-close'>
              <img className='port-modal-user-img' src={Logo}></img>
              <img src={X} onClick={closeDeleteModal} className="port-modal-user-close-button"></img>
            </div>
